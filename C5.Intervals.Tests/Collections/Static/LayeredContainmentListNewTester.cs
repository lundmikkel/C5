...
{
    namespace LayeredContainmentListNew
    {
        #region Black-box
        ...
        class LayeredContainmentListTester_BlackBox : IntervalCollectionTester
        {
            ...
            {
                return typeof(LayeredContainmentListNew<,>);
            }
        ...
        public class Statement
        {
            ...
            {
                CollectionAssert.AreEquivalent(Enumerable.Empty<IInterval<int>>(), new LayeredContainmentListNew<IInterval<int>, int>(Enumerable.Empty<IInterval<int>>()));
            }

            [Test]
            public void Constructor_OneInterval()
            {
                CollectionAssert.AreEquivalent(dataSetA, new LayeredContainmentListNew<IInterval<int>, int>(dataSetA));
            }

            [Test]
            public void Constructor_MoreThanOneIntervalAndOneContainmentLayer()
            {
                CollectionAssert.AreEquivalent(dataSetB, new LayeredContainmentListNew<IInterval<int>, int>(dataSetB));
            }

            [Test]
            public void Constructor_MoreThanOneIntervalAndTwoContainmentLayers()
            {
                CollectionAssert.AreEquivalent(dataSetC, new LayeredContainmentListNew<IInterval<int>, int>(dataSetC));
            }

            [Test]
            public void Constructor_MoreThanOneIntervalAndMoreThanTwoContainmentLayers()
            {
                CollectionAssert.AreEquivalent(dataSetD, new LayeredContainmentListNew<IInterval<int>, int>(dataSetD));
            }

            [Test]
            public void Constructor_ThreeContainments()
            {
                var moreThanOne = new LayeredContainmentListNew<IInterval<int>, int>(new[]
                    {
            ...
            {
                var moreThanOne = new LayeredContainmentListNew<IInterval<int>, int>(new[] { J, L });
            ...
            */
            ...
            {
                Assert.AreEqual(0, new LayeredContainmentListNew<IInterval<int>, int>(Enumerable.Empty<IInterval<int>>()).
            ...
            {
                //Assert.AreEqual(0, new LayeredContainmentListNew<IInterval<int>, int>(Enumerable.Empty<IInterval<int>>()).CountOverlaps(null));
            }

            [Test]
            public void CountOverlap_OneInterval()
            {
                Assert.AreEqual(1, new LayeredContainmentListNew<IInterval<int>, int>(dataSetA).
                    CountOverlaps(new IntervalBase<int>(2, 7, true, true)));
            }
            ...
            {
                Assert.AreEqual(1, new LayeredContainmentListNew<IInterval<int>, int>(new[] { new IntervalBase<int>(2, 7, false, true) }).
                    CountOverlaps(new IntervalBase<int>(2, 7, true, true)));
            }
            ...
            {
                Assert.AreEqual(1, new LayeredContainmentListNew<IInterval<int>, int>(new[]
                    {
            ...
            {
                Assert.AreEqual(0, new LayeredContainmentListNew<IInterval<int>, int>(new[]
                    {
            ...
            {
                Assert.AreEqual(5, new LayeredContainmentListNew<IInterval<int>, int>(dataSetD).
                    CountOverlaps(new IntervalBase<int>(6, 9, true, true)));
            }
            ...
            {
                Assert.AreEqual(3, new LayeredContainmentListNew<IInterval<int>, int>(dataSetF).
                    CountOverlaps(new IntervalBase<int>(6, 7, true, true)));
            }
            ...
            {
                Assert.AreEqual(0, new LayeredContainmentListNew<IInterval<int>, int>(dataSetE).
                    CountOverlaps(new IntervalBase<int>(1, 2, true, true)));
            }
            ...
            {
                CollectionAssert.AreEquivalent(Enumerable.Empty<IInterval<int>>(), new LayeredContainmentListNew<IInterval<int>, int>(Enumerable.Empty<IInterval<int>>()).FindOverlaps(2));
            }

            [Test]
            public void FindOverlapsRange_QueryZeroIntervals()
            {
                CollectionAssert.AreEquivalent(Enumerable.Empty<IInterval<int>>(), new LayeredContainmentListNew<IInterval<int>, int>(Enumerable.Empty<IInterval<int>>()).FindOverlaps(new IntervalBase<int>(21, 23, true, true)));
            }

            [Test]
            public void FindOverlapsStabbing_QueryPointOneOrMoreIntervals()
            {
                CollectionAssert.AreEquivalent(new[] { A }, new LayeredContainmentListNew<IInterval<int>, int>(dataSetB).FindOverlaps(2));
            }

            [Test]
            public void FindOverlaps_MoreThanOneIntervalQueryAfter()
            {
                Assert.AreEqual(Enumerable.Empty<IInterval<int>>(), new LayeredContainmentListNew<IInterval<int>, int>(dataSetE).FindOverlaps(new IntervalBase<int>(21, 23, true, true)));
            }

            [Test]
            public void FindOverlaps_ContainmentQueryHits()
            {
                Assert.AreEqual(3, new LayeredContainmentListNew<IInterval<int>, int>(dataSetF).FindOverlaps(new IntervalBase<int>(6, 7, true, true)).Count());
            }

            [Test]
            public void FindOverlaps_MoreThanOneIntervalQueryBefore()
            {
                Assert.AreEqual(Enumerable.Empty<IInterval<int>>(), new LayeredContainmentListNew<IInterval<int>, int>(dataSetE).FindOverlaps(new IntervalBase<int>(1, 2, true, true)));
            }
            ...
            public void Enumerator_Empty()
            {
                ...
                var list = new LayeredContainmentListNew<IInterval<int>, int>(Enumerable.Empty<IInterval<int>>());
            ...
            {
                var result = new ArrayList<IInterval<int>>();
                var list = new LayeredContainmentListNew<IInterval<int>, int>(dataSetA);
                var enumerator = list.GetEnumerator();
            ...
            {
                var result = new ArrayList<IInterval<int>>();
                var list = new LayeredContainmentListNew<IInterval<int>, int>(dataSetC);
                var enumerator = list.GetEnumerator();
            ...
            {
                var result = new ArrayList<IInterval<int>>();
                var list = new LayeredContainmentListNew<IInterval<int>, int>(dataSetG);
                var enumerator = list.GetEnumerator();
            ...
            {
                //Assert.Throws<InvalidOperationException>(() => { var span = new LayeredContainmentListNew<IInterval<int>, int>(Enumerable.Empty<IInterval<int>>()).Span; });
            }

            [Test]
            public void Span_MoreThanZero()
            {
                Assert.That(new LayeredContainmentListNew<IInterval<int>, int>(dataSetB).Span.Equals(new IntervalBase<int>(1, 20, true, true)));
            }
            ...
            {
                Assert.False(new LayeredContainmentListNew<IInterval<int>, int>(Enumerable.Empty<IInterval<int>>()).
            ...
            {
                Assert.False(new LayeredContainmentListNew<IInterval<int>, int>(dataSetB).FindOverlap(new IntervalBase<int>(21, 23, true, true), out _overlap));
            }

            [Test]
            public void OverlapExists_Hit()
            {
                Assert.True(new LayeredContainmentListNew<IInterval<int>, int>(dataSetB).FindOverlap(new IntervalBase<int>(4, 5, true, true), out _overlap));
            }

            [Test]
            public void OverlapExists_NoHit()
            {
                Assert.False(new LayeredContainmentListNew<IInterval<int>, int>(dataSetE).FindOverlap(new IntervalBase<int>(9, 11, true, true), out _overlap));
            }
            ...
            {
                Assert.That(new LayeredContainmentListNew<IInterval<int>, int>(dataSetA).CountSpeed.Equals(Speed.Constant));
            }
            ...
            public void Choose_Empty()
            {
                ...
                { new LayeredContainmentListNew<IInterval<int>, int>(Enumerable.Empty<IInterval<int>>()).Choose(); });
            }

            [Test]
            public void Choose_NotEmpty()
            {
                Assert.NotNull(new LayeredContainmentListNew<IInterval<int>, int>(dataSetA).Choose());
            }
        ...
        class FormerBugs
        {
            ...
            public void Constructor_DoubleContainedInterval_MovedToNewLayer()
            {
                ...
                var collection = new LayeredContainmentListNew<IInterval<int>, int>(intervals);
                ...
                collection = new LayeredContainmentListNew<IInterval<int>, int>(intervals);
