...
{
    namespace IntervalBinarySearchTreeRegular
    {
        #region Black-box

        abstract class IntervalBinarySearchTreeRegularTester_BlackBox : IntervalCollectionTester
        {
            protected override Type GetCollectionType()
            {
                return typeof(IntervalBinarySearchTreeRegular<,>);
            }
        ...
        class IntervalBinarySearchTreeRegularTesterPreConstruct_BlackBox : IntervalBinarySearchTreeRegularTester_BlackBox
        {
        ...
        class IntervalBinarySearchTreeRegularTesterRegular_BlackBox : IntervalBinarySearchTreeRegularTester_BlackBox
        {
            protected override object[] AdditionalParameters()
            {
        ...
        [TestFixture]
        class IntervalBinarySearchTreeRegularTester_WhiteBox
        {
            #region Helpers
            // TODO: Builder pattern

            private static IntervalBinarySearchTreeRegular<IInterval<int>, int> _createIBS(params IInterval<int>[] intervals)
            {
                return new IntervalBinarySearchTreeRegular<IInterval<int>, int>(intervals);
            }
        ...
        internal class FormerBugs
        {
            ...
            public void Span_CachingSpan()
            {
                ...
                var collection = new IntervalBinarySearchTreeRegular<IntervalBase<int>, int>
                    {
                        interval,
