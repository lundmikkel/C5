...
namespace C5.Tests.intervals
{
    ...
    namespace NestedContainmentList2
    {
        ...
        public class OrderImportanceForNesting
        {
            ...
            public void Init()
            {
                _intervalCollection = new NestedContainmentList2<IInterval<int>, int>(
                    new[]
                        {
        ...
        namespace Count
        {
            ...
            public class NoContainments
            {
                ...
                public void Init()
                {
                    _intervalCollection = new NestedContainmentList2<IInterval<int>, int>(new ArrayList<IInterval<int>>
                    {
        ...
        namespace BinarySearch
        {
            ...
            {
                private NestedContainmentList2<IInterval<int>, int> _intervaled;
                ...
                public void Init()
                {
                    _intervaled = new NestedContainmentList2<IInterval<int>, int>(new[] {A, B, C, D, E, F, G, H, I});
                }
        ...
        */
        ...
        public class StabbingQuery
        {
            ...
            public void Init()
            {
                _intervaled = new NestedContainmentList2<IInterval<int>, int>(new[] { A, B, C, D, E, F, G });
            }
