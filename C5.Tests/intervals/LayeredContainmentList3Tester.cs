...
{
    namespace LayeredContainmentList3
    {
        ...
        public class LCListEndpointInclusion : IntervaledEndpointInclusion
        {
            ...
            {
                return new LayeredContainmentList3<IInterval<int>, int>(intervals);
            }
        }
        ...
        public class LCListIBS : IBS
        {
            ...
            public void Print()
            {
                File.WriteAllText(@"../../intervals/data/layered_containment_list.gv", ((LayeredContainmentList3<IInterval<int>, int>) IntervalCollection).Graphviz());
            }
        }
        ...
        [TestFixture]
        public class LayeredContainmentList3_LargeTest : LargeTest_100000
        {
            protected override IIntervalCollection<IInterval<int>, int> Factory(IEnumerable<IInterval<int>> intervals)
            {
                return new LayeredContainmentList3<IInterval<int>, int>(intervals);
        ...
        public class LCList100000Perfomance : Performance100000
        {
            ...
            public void Print()
            {
                File.WriteAllText(@"../../intervals/data/lclist100000.gv", ((LayeredContainmentList3<IInterval<int>, int>) IntervalCollection).Graphviz());
            }
        }
        ...
        public class LCListContainmentInSameLayer
        {
            ...
            public void SetUp()
            {
                _intervalCollection = new LayeredContainmentList3<IInterval<int>, int>(new[] { A, B, C, D, E });
            }
        ...
        public class LCListExample
        {
            ...
            public void SetUp()
            {
                _intervalCollection = new LayeredContainmentList3<IInterval<int>, int>(new[] { A, B, C, D, E, F, G, H, I, J });
            }

            [Test]
            public void GetEnumerator()
            {
                CollectionAssert.AreEqual(new[] { A, B, C, D, E, F, G, H, I, J }, _intervalCollection);
            }
        ...
        namespace Count
        {
            ...
            public class LCListNoContainments
            {
                ...
                public void Init()
                {
                    _intervalCollection = new LayeredContainmentList3<IInterval<int>, int>(new ArrayList<IInterval<int>>
                    {
            ...
            public class LCListMixedContainments
            {
                ...
                public void Print()
                {
                    Console.WriteLine(((LayeredContainmentList3<IInterval<int>, int>) _intervalCollection).Graphviz());
                }
        ...
        namespace BinarySearch
        {
            ...
            {
                private LayeredContainmentList3<IInterval<int>, int> _intervaled;
                ...
                public void Init()
                {
                    _intervaled = new LayeredContainmentList3<IInterval<int>, int>(new[] {A, B, C, D, E, F, G, H, I});
                }
        ...
        */
        ...
        public class StabbingQuery
        {
            ...
            public void Init()
            {
                _intervaled = new LayeredContainmentList3<IInterval<int>, int>(new[] { A, B, C, D, E, F, G });
            }
        ...
        public class Statement
        {
            ...
            {
                CollectionAssert.AreEquivalent(Enumerable.Empty<IInterval<int>>(), new LayeredContainmentList3<IInterval<int>, int>(Enumerable.Empty<IInterval<int>>()));
            }

            [Test]
            public void Constructor_OneInterval()
            {
                CollectionAssert.AreEquivalent(dataSetA, new LayeredContainmentList3<IInterval<int>, int>(dataSetA));
            }

            [Test]
            public void Constructor_MoreThanOneIntervalAndOneContainmentLayer()
            {
                CollectionAssert.AreEquivalent(dataSetB, new LayeredContainmentList3<IInterval<int>, int>(dataSetB));
            }

            [Test]
            public void Constructor_MoreThanOneIntervalAndTwoContainmentLayers()
            {
                CollectionAssert.AreEquivalent(dataSetC, new LayeredContainmentList3<IInterval<int>, int>(dataSetC));
            }

            [Test]
            public void Constructor_MoreThanOneIntervalAndMoreThanTwoContainmentLayers()
            {
                CollectionAssert.AreEquivalent(dataSetD, new LayeredContainmentList3<IInterval<int>, int>(dataSetD));
            }

            [Test]
            public void Constructor_ThreeContainments()
            {
                var moreThanOne = new LayeredContainmentList3<IInterval<int>, int>(new[]
                    {
            ...
            {
                var moreThanOne = new LayeredContainmentList3<IInterval<int>, int>(new[] { J, L });
            ...
            */
            ...
            {
                Assert.AreEqual(0, new LayeredContainmentList3<IInterval<int>, int>(Enumerable.Empty<IInterval<int>>()).
            ...
            {
                Assert.AreEqual(1, new LayeredContainmentList3<IInterval<int>, int>(dataSetA).
                    CountOverlaps(new IntervalBase<int>(2, 7, true, true)));
            }
            ...
            {
                Assert.AreEqual(1, new LayeredContainmentList3<IInterval<int>, int>(new[] { new IntervalBase<int>(2, 7, false, true) }).
                    CountOverlaps(new IntervalBase<int>(2, 7, true, true)));
            }
            ...
            {
                Assert.AreEqual(1, new LayeredContainmentList3<IInterval<int>, int>(new[]
                    {
                        new IntervalBase<int>(2, 7, true, true),
            ...
            {
                Assert.AreEqual(0, new LayeredContainmentList3<IInterval<int>, int>(new[]
                    {
            ...
            {
                Assert.AreEqual(5, new LayeredContainmentList3<IInterval<int>, int>(dataSetD).
                    CountOverlaps(new IntervalBase<int>(6, 9, true, true)));
            }
            ...
            {
                Assert.AreEqual(0, new LayeredContainmentList3<IInterval<int>, int>(dataSetB).
                    CountOverlaps(null));
            }
            ...
            {
                Assert.AreEqual(3, new LayeredContainmentList3<IInterval<int>, int>(dataSetF).
                    CountOverlaps(new IntervalBase<int>(6, 7, true, true)));
            }
            ...
            {
                Assert.AreEqual(0, new LayeredContainmentList3<IInterval<int>, int>(dataSetE).
                    CountOverlaps(new IntervalBase<int>(1, 2, true, true)));
            }
            ...
            {
                CollectionAssert.AreEquivalent(Enumerable.Empty<IInterval<int>>(), new LayeredContainmentList3<IInterval<int>, int>(Enumerable.Empty<IInterval<int>>()).FindOverlaps(null));
            }

            [Test]
            public void FindOverlaps_NullQueryOneOrMoreIntervals()
            {
                CollectionAssert.AreEquivalent(Enumerable.Empty<IInterval<int>>(), new LayeredContainmentList3<IInterval<int>, int>(dataSetB).FindOverlaps(null));
            }

            [Test]
            public void FindOverlapsStabbing_QueryZeroIntervals()
            {
                CollectionAssert.AreEquivalent(Enumerable.Empty<IInterval<int>>(), new LayeredContainmentList3<IInterval<int>, int>(Enumerable.Empty<IInterval<int>>()).FindOverlaps(2));
            }

            [Test]
            public void FindOverlapsRange_QueryZeroIntervals()
            {
                CollectionAssert.AreEquivalent(Enumerable.Empty<IInterval<int>>(), new LayeredContainmentList3<IInterval<int>, int>(Enumerable.Empty<IInterval<int>>()).FindOverlaps(new IntervalBase<int>(21, 23, true, true)));
            }

            [Test]
            public void FindOverlapsStabbing_QueryPointOneOrMoreIntervals()
            {
                CollectionAssert.AreEquivalent(new[] { A }, new LayeredContainmentList3<IInterval<int>, int>(dataSetB).FindOverlaps(2));
            }

            [Test]
            public void FindOverlaps_MoreThanOneIntervalQueryAfter()
            {
                Assert.AreEqual(Enumerable.Empty<IInterval<int>>(), new LayeredContainmentList3<IInterval<int>, int>(dataSetE).FindOverlaps(new IntervalBase<int>(21, 23, true, true)));
            }

            [Test]
            public void FindOverlaps_ContainmentQueryHits()
            {
                Assert.AreEqual(3, new LayeredContainmentList3<IInterval<int>, int>(dataSetF).FindOverlaps(new IntervalBase<int>(6, 7, true, true)).Count());
            }

            [Test]
            public void FindOverlaps_MoreThanOneIntervalQueryBefore()
            {
                Assert.AreEqual(Enumerable.Empty<IInterval<int>>(), new LayeredContainmentList3<IInterval<int>, int>(dataSetE).FindOverlaps(new IntervalBase<int>(1, 2, true, true)));
            }
            ...
            public void Enumerator_Empty()
            {
                ...
                var list = new LayeredContainmentList3<IInterval<int>, int>(Enumerable.Empty<IInterval<int>>());
            ...
            {
                var result = new ArrayList<IInterval<int>>();
                var list = new LayeredContainmentList3<IInterval<int>, int>(dataSetA);
                var enumerator = list.GetEnumerator();
            ...
            {
                var result = new ArrayList<IInterval<int>>();
                var list = new LayeredContainmentList3<IInterval<int>, int>(dataSetC);
                var enumerator = list.GetEnumerator();
            ...
            {
                var result = new ArrayList<IInterval<int>>();
                var list = new LayeredContainmentList3<IInterval<int>, int>(dataSetG);
                var enumerator = list.GetEnumerator();
            ...
            {
                Assert.Throws<InvalidOperationException>(() => { var span = new LayeredContainmentList3<IInterval<int>, int>(Enumerable.Empty<IInterval<int>>()).Span; });
            }

            [Test]
            public void Span_MoreThanZero()
            {
                Assert.That(new LayeredContainmentList3<IInterval<int>, int>(dataSetB).Span.Equals(new IntervalBase<int>(1, 20, true, true)));
            }
            ...
            {
                Assert.False(new LayeredContainmentList3<IInterval<int>, int>(dataSetB).FindOverlap(null, ref overlap));
            }

            [Test]
            public void OverlapExists_Empty()
            {
                Assert.False(new LayeredContainmentList3<IInterval<int>, int>(Enumerable.Empty<IInterval<int>>()).
            ...
            {
                Assert.False(new LayeredContainmentList3<IInterval<int>, int>(dataSetB).FindOverlap(new IntervalBase<int>(21, 23, true, true), ref overlap));
            }

            [Test]
            public void OverlapExists_Hit()
            {
                Assert.True(new LayeredContainmentList3<IInterval<int>, int>(dataSetB).FindOverlap(new IntervalBase<int>(4, 5, true, true), ref overlap));
            }

            [Test]
            public void OverlapExists_NoHit()
            {
                Assert.False(new LayeredContainmentList3<IInterval<int>, int>(dataSetE).FindOverlap(new IntervalBase<int>(9, 11, true, true), ref overlap));
            }
            ...
            {
                Assert.That(new LayeredContainmentList3<IInterval<int>, int>(dataSetA).CountSpeed.Equals(Speed.Constant));
            }
            ...
            public void Choose_Empty()
            {
                Assert.Throws<NoSuchItemException>(() =>
                    { var choose = new LayeredContainmentList3<IInterval<int>, int>(Enumerable.Empty<IInterval<int>>()).Choose(); });
            }

            [Test]
            public void Choose_NotEmpty()
            {
                Assert.NotNull(new LayeredContainmentList3<IInterval<int>, int>(dataSetA).Choose());
            }
