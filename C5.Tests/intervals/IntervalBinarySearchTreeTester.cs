...
namespace C5.Tests.intervals
{
    ...
    namespace IntervalBinarySearchTree
    {
        ...
        public class BensTest : intervals.Generic.BensTest
        {
            ...
            {
                Assert.AreEqual(2, ((IntervalBinarySearchTree<IInterval<int>, int>) _intervalCollection).MaximumOverlap);
            }
        }
        ...
        public class IBSRemove
        {
            ...
            private IntervalBinarySearchTree<IInterval<int>, int> _intervales;
            ...
            public void Init()
            {
                _intervales = new IntervalBinarySearchTree<IInterval<int>, int>()
                    {
                        A, B, C, D, E1, E2, F, G, H
                    };
        ...
        {
            private IntervalBinarySearchTree<IInterval<int>, int> _intervaled;

            [SetUp]
            public void Init()
            {
                _intervaled = new IntervalBinarySearchTree<IInterval<int>, int>();
            }
