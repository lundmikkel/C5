...
namespace C5.Intervals
{
    ...
    public class LayeredContainmentListNewSplit<I, T> : CollectionValueBase<I>, IIntervalCollection<I, T>
        ...
        where T : IComparable<T>
    {
        ...
        public LayeredContainmentListNewSplit(IEnumerable<I> intervals)
        {
